...
![Alt](https://github.com/WHOIGit/PhytO-ARM/blob/master/website/static/images/Bag1.jpeg)

To use our bag solution simply slide the bag over MAC400 on the final assembled PhytoArm system and close the hook and loops where possible. Hit the bag with a heat gun to shrink the bag and reduce size of openings for environmental damage.

![Alt](https://github.com/WHOIGit/PhytO-ARM/blob/master/website/static/images/Bag2.jpegß)
...
![Alt](https://github.com/WHOIGit/PhytO-ARM/blob/master/website/static/images/Box1.jpeg)

Fit the Motor into protective Case Next, Set \#10 bolts in the bottom and top holes on the motor face, four in all, with washers between the bolt head and the motor casing.

![Alt](https://github.com/WHOIGit/PhytO-ARM/blob/master/website/static/images/Box2.jpeg)

This next step is easiest done with the case placed with the opening facing up. With the bolts in place, carefully tip the motor forward and guide the motor shaft at an angle through the face of the case. Press the back of the motor down until it is in place at the bottom of the case. This may take some force, but it will slide into place. Adjust so the motor face is seated in the opening in the case. Tip forward so the bolts slide through the bores in the case. Insert a hex key through the slots on either side of the case and find the bolt head. Holding the bolt in place from the inside, finger-tighten a lock nut on the end of each bolt. This will ensure that as the motor is moved around, the bolts don't slip out fall into the case. When docking motor to conedrive gearbox simply remove these lock nuts.
